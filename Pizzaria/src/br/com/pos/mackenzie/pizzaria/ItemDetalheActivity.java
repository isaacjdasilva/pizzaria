...
public class ItemDetalheActivity extends PizzariaActivity {
	...
	public static final Integer ACTIVITY_TELA = R.layout.item_detalhe;
...
//		imagem_item_detalhe = (ImageView) findViewById(R.id.imagem_item_detalhe);
	...
	public void telaConfigurarCompra() {
		Intent intent = new Intent(ItemDetalheActivity.this, TelaGerenciaClienteActivity.class);
...
//					.getInt(TelaIngredienteActivity.PARAMETRO_ITEM_SELECIONADO);
